...
import 'package:offcourse/pages/nav_pages/successWithoutCourse.dart';
import 'package:offcourse/widgets/defaultAppBar.dart';
import 'package:offcourse/widgets/stickyLabel.dart';

import '../additional/colors.dart';

class PaymentDetailsWC extends StatefulWidget {
  PaymentDetailsWC({Key? key}) : super(key: key);

  @override
  _PaymentDetailsState createState() => _PaymentDetailsState();
}

class _PaymentDetailsState extends State<PaymentDetailsWC> {
